...
const stringlang = {
    fr: {
        ...
        social: ["Github.","LinkedIn.","Twitch.","Itch.io", "Mail."]
    },
    en: {
        name: "Diamant Lelouette.",
    ...
    espo: {
        ...
        social: ["Githubo.","LinkedIno.","Twitcho.","Itcho.io", "Mailo."]
    },
    translator: {
        ...
        social: ["Certaines des riches difficultés sociales.","Chacune des jambes.","Riches.","Oh, dans un court laps de temps et rapidement.", "Sujet principal."]
    }
}
